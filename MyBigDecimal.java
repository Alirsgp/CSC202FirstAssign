...
public class MyBigDecimal implements NumericalOperand {
	...
	public String addOp(String str1, String str2) {
		...
		if(((arraylistFinal.size() + 1) > tempstr1.length()) && (arraylistFinal.size()) > tempstr2.length()) {
			moveOneOverDecimal = true;
		}
		else if(hasDec1 && hasDec2 == false) {
		if(((arraylistFinal.size() + 1) > tempstr1.length()) && (arraylistFinal.size()) > tempstr2.length()) {
			moveOneOverDecimal = true;
		}
		} else if(hasDec1 == false && hasDec2) {
		if(((arraylistFinal.size()) > tempstr1.length()) && (arraylistFinal.size() + 1) > tempstr2.length()) {
			moveOneOverDecimal = true;
		} 
		}else if(hasDec1 && hasDec2) {
		if(((arraylistFinal.size() + 1) > tempstr1.length()) && (arraylistFinal.size() + 1) > tempstr2.length()) {
			moveOneOverDecimal = true;
		} 
		}else if(hasDec1 == false && hasDec2 == false) {
		if(((arraylistFinal.size()) > tempstr1.length()) && (arraylistFinal.size()) > tempstr2.length()) {
			moveOneOverDecimal = true;
		}
		}
		...
		if(indexOfFirstDecimalOfFirstString > 0 || indexOfsecondDecimalOfSecondString > 0) {
			if((str1.length() == str2.length()) && moveOneOverDecimal == true && (hasDec1 && hasDec2)) {
		...
		} else if(str1.length() > str2.length() && (tempstr1.substring(0, 1).equals(".") && tempstr2.substring(0, 1).equals(".")) && moveOneOverDecimal) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString, ".");
		
		} else if(str2.length() > str1.length() && (tempstr1.substring(0, 1).equals(".") && tempstr2.substring(0, 1).equals(".")) && moveOneOverDecimal == false) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString, ".");
	
		} else if(str2.length() > str1.length() && (tempstr1.substring(0, 1).equals(".") && tempstr2.substring(0, 1).equals(".")) && moveOneOverDecimal == true) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString, ".");
		
		} else if(str1.length() > str2.length() && moveOneOverDecimal == true && (tempstr1.substring(0, 1).equals(".") && !tempstr2.substring(0, 1).equals("."))) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString, ".");
			
		} else if(str2.length() > str1.length() && moveOneOverDecimal == true && (tempstr2.substring(0, 1).equals(".") && !tempstr1.substring(0, 1).equals("."))) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString, ".");
		
		}else if(str1.length() > str2.length() && moveOneOverDecimal == true && (hasDec1 && hasDec2 == false)) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString, ".");
			
		} else if(str1.length() > str2.length() && moveOneOverDecimal == true && (hasDec2 && hasDec1 == false)) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString, ".");
		
		} else if(str2.length() > str1.length() && moveOneOverDecimal == true && (hasDec1 && hasDec2 == false)) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString, ".");
			
		} else if(str2.length() > str1.length() && moveOneOverDecimal == true ) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString + 1, ".");
			
		} else if(str2.length() > str1.length() && moveOneOverDecimal == true) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString + 1, ".");
			
		} else if(str1.length() > str2.length() && moveOneOverDecimal) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString + 1, ".");
		
		} else if(str2.length() > str1.length() && moveOneOverDecimal) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString + 1, ".");
		
		} else if(str1.length() > str2.length() && (tempstr1.substring(0, 1).equals(".") && tempstr2.substring(0, 1).equals("."))) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString - 1, ".");
		
		} else if(str2.length() > str1.length() && (tempstr1.substring(0, 1).equals(".") && tempstr2.substring(0, 1).equals("."))) {
			arraylistFinal.add(indexOfsecondDecimalOfSecondString - 1, ".");
			...
			arraylistFinal.add(indexOfFirstDecimalOfFirstString + 1, ".");
		} else if ((str1.length() == str2.length() && moveOneOverDecimal == false && (tempstr1.substring(0, 1).equals(".") && tempstr2.substring(0, 1).equals(".")))) {
			arraylistFinal.add(indexOfFirstDecimalOfFirstString - 1, ".");
	...
	public String subOp(String str1, String str2) {
		...
		***/
		...
		if(((arraylistFinalSub.size() + 1) < tempstr1Sub.length()) && (arraylistFinalSub.size()) < tempstr2Sub.length()) {
			moveOneOverDecimalSub = true;
		} else if(((arraylistFinalSub.size() + 1) < tempstr2Sub.length()) && (arraylistFinalSub.size()) < tempstr1Sub.length()) {
			moveOneOverDecimalSub = true;
		} 
		else if(hasDec1Sub && hasDec2Sub == false) {
		if(((arraylistFinalSub.size() + 1) < tempstr1Sub.length()) && (arraylistFinalSub.size()) < tempstr2Sub.length()) {
			moveOneOverDecimalSub = true;
		}
		} else if(hasDec1Sub == false && hasDec2Sub) {
		if(((arraylistFinalSub.size()) < tempstr1Sub.length()) && (arraylistFinalSub.size() + 1) < tempstr2Sub.length()) {
			moveOneOverDecimalSub = true;
		} 
		}else if(hasDec1Sub && hasDec2Sub) {
		if(((arraylistFinalSub.size() + 1) < tempstr1Sub.length()) && (arraylistFinalSub.size() + 1) < tempstr2Sub.length()) {
			moveOneOverDecimalSub = true;
		} 
		}else if(hasDec1Sub == false && hasDec2Sub == false) {
		if(((arraylistFinalSub.size()) < tempstr1Sub.length()) && (arraylistFinalSub.size()) < tempstr2Sub.length()) {
			moveOneOverDecimalSub = true;
		}
		}
		...
		if(indexOfFirstDecimalOfFirstStringSub > 0 || indexOfsecondDecimalOfSecondStringSub > 0) {
			if((tempstr1Sub.length() == tempstr2Sub.length()) && moveOneOverDecimalSub == true) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub + 1, ".");
			
		} else if ((tempstr1Sub.length() != tempstr2Sub.length() && moveOneOverDecimalSub == false) && (checkMoveDecimalTwice)) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub, ".");
			
		} else if(tempstr1Sub.length() > tempstr2Sub.length() && (tempstr1Sub.substring(0, 1).equals(".") && tempstr2Sub.substring(0, 1).equals(".")) && moveOneOverDecimalSub) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub - 1, ".");
			
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && (tempstr1Sub.substring(0, 1).equals(".") && tempstr2Sub.substring(0, 1).equals(".")) && moveOneOverDecimalSub == false) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub - 1, ".");
			
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && (tempstr1Sub.substring(0, 1).equals(".") && tempstr2Sub.substring(0, 1).equals(".")) && moveOneOverDecimalSub == true) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub - 1, ".");
			
		} else if(tempstr1Sub.length() > tempstr2Sub.length() && moveOneOverDecimalSub == true && (tempstr1Sub.substring(0, 1).equals(".") && !tempstr2Sub.substring(0, 1).equals("."))) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub, ".");
			
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && moveOneOverDecimalSub == true && (tempstr2Sub.substring(0, 1).equals(".") && !tempstr1Sub.substring(0, 1).equals("."))) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub, ".");
			
		}else if(tempstr1Sub.length() > tempstr2Sub.length() && moveOneOverDecimalSub == true && (hasDec1Sub && hasDec2Sub == false)) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub, ".");
		
		} else if(tempstr1Sub.length() > tempstr2Sub.length() && moveOneOverDecimalSub == true && (hasDec2Sub && hasDec1Sub == false)) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub, ".");
			
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && moveOneOverDecimalSub == true && (hasDec1Sub && hasDec2Sub == false)) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub, ".");
		
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && moveOneOverDecimalSub == true ) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub + 1, ".");
			
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && moveOneOverDecimalSub == true) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub + 1, ".");
			
		} else if(tempstr1Sub.length() > tempstr2Sub.length() && moveOneOverDecimalSub) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub - 1, ".");
		
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && moveOneOverDecimalSub) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub + 1, ".");
			
		} else if(tempstr1Sub.length() > tempstr2Sub.length() && (tempstr1Sub.substring(0, 1).equals(".") && tempstr2Sub.substring(0, 1).equals("."))) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub - 1, ".");
			
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && (tempstr1Sub.substring(0, 1).equals(".") && tempstr2Sub.substring(0, 1).equals("."))) {
			arraylistFinalSub.add(indexOfsecondDecimalOfSecondStringSub - 1, ".");
		
		} else if(tempstr1Sub.length() > tempstr2Sub.length() && arraylistFinalSub.size() < tempstr1Sub.length()) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub, ".");
	
		} else if(tempstr2Sub.length() > tempstr1Sub.length() && arraylistFinalSub.size() < tempstr2Sub.length()) {
			arraylistFinalSub.add(tempstr2Sub.length() - 2, ".");
	
		} else if((tempstr1Sub.length() == tempstr2Sub.length()) && moveOneOverDecimalSub == true) {
			
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub + 1, ".");
		} else if ((tempstr1Sub.length() == tempstr2Sub.length() && moveOneOverDecimalSub == false && (tempstr1Sub.substring(0, 1).equals(".") && tempstr2Sub.substring(0, 1).equals(".")))) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub - 1, ".");
		
		}  else if ((tempstr1Sub.length() == tempstr2Sub.length() && moveOneOverDecimalSub == false)) {
			arraylistFinalSub.add(indexOfFirstDecimalOfFirstStringSub, ".");
